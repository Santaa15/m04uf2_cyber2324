...
title = "Bienvenido al juego de FaryAdventures"
...
while not encontrado:
    ...
    if not character:
        print("Error: id no encotrado")
    else:
        encontrado = True

print("\nEl perosnaje esocgido es:\n")
...
file = open('characters_items.factous', 'r')
